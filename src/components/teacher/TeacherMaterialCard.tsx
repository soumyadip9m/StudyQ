...
import { deleteMaterial } from '../../utils/materials';
...
const TeacherMaterialCard: React.FC<TeacherMaterialCardProps> = ({ material, onUpdate }) => {
  const { user } = useAuth();
            ...
            {showMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10 border border-gray-200">
                <div className="py-1">
                  <button
                    onClick={() => {
                      // Handle edit - for now just close menu
                      setShowMenu(false);
                    }}
...
export default TeacherMaterialCard;